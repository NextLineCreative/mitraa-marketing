  ...
  return (
    <LegalDoc title="Refund and Cancellation Policy" effectiveDate={EFFECTIVE} lastUpdated={UPDATED}>
      <p>
        ...
        (&ldquo;recharges&rdquo;) made through the Mitraa application or website. It
        is part of, and should be read together with, our{' '}
      ...
      <h2>2. When you may be eligible for a refund</h2>
      ...
      <ul>
        ...
        <li>the Razorpay order ID or payment ID (visible on your bank/UPI statement);</li>
      ...
      <ul>
        ...
        <li>Approved refunds are reversed to the original payment method through Razorpay. The amount usually appears in your account within 5&ndash;10 business days, depending on your bank or UPI provider.</li>
      ...
      <h2>6. Subscriptions and packs</h2>
